...
zooAnimals.map(el => lowerCase.push(el.animal_name.toLowerCase()));
...
largerPopulation = zooAnimals.filter(el => el.population < 5);
...
populationTotal = zooAnimals.reduce((acc, el) => {
